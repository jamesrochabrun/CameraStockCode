...
class CameraVC: UIViewController {
    ...
    lazy var photoModeButton: UIButton = {
        ...
        b.setImage(#imageLiteral(resourceName: "Photo Camera Icon"), for: .normal)
        return b
    }()
    ...
    lazy var videoModeButton: UIButton = {
        let b = UIButton()
        b.setImage(#imageLiteral(resourceName: "Video Camera Icon"), for: .normal)
        b.translatesAutoresizingMaskIntoConstraints = false
        return b
    }()
    ...
    func setUpViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            videoModeButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -30),
            videoModeButton.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 30),
            videoModeButton.heightAnchor.constraint(equalTo: toggleFlashButton.heightAnchor),
            videoModeButton.widthAnchor.constraint(equalTo: toggleFlashButton.widthAnchor),
            
            photoModeButton.bottomAnchor.constraint(equalTo: videoModeButton.topAnchor, constant: -30),
            photoModeButton.leftAnchor.constraint(equalTo: videoModeButton.leftAnchor),
            photoModeButton.heightAnchor.constraint(equalTo: toggleFlashButton.heightAnchor),
            photoModeButton.widthAnchor.constraint(equalTo: toggleFlashButton.widthAnchor),
